...
/**
 * Class Key represents the predefined tables ( subBox, inverse subBox, Rcon)  used for the AES encryption and decrytpion
 *
 * @author J.Houssem
 * @version 1.0
 */
public class SubByteBox {


    public final byte[][] subBox = {
